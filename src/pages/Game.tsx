...
function Game() {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-slate-700">
      <Popup
        title="Let's Start!"
        description={`When the game start, you will need to give the customer the refund. NO CENT CAN BE WRONG! You can see the purchase value in the monitor at left. Good luck!`}
        handler={() => setGameState("start")}
        className="start-popup"
      ></Popup>
      <Popup
        title={`Oh, you got ${score} points!`}
        description={`${score < 40 ? "Ok, I know you have another type of intelligence." : score < 70 ? "Mid." : score < 90 ? "Whoa, congragulations." : "Bro, you rocked!"}`}
      ...
      >
        ...
        <div className="w-full h-full flex gap-x-4">
          ...
          <div
            className={`w-[calc(100%-306px)] h-[224px] flex flex-col gap-y-4`}
          >
            <div
